...
class EnrichedClinicalSpec extends SparkSpec with WithTestConfig {
  ...
  it should "transform normalized clinical data into a single clinical reference table" in {
    ...
    result
      ...
      // 1. Trio
      EnrichedClinicalOutput(patient_id = "PA0001", gender = "Male", analysis_service_request_id = "SRA0001", service_request_id = "SRS0001", bioinfo_analysis_code = "GEAN", practitioner_role_id = "PPR00101", batch_id = "BAT1", aliquot_id = "1", specimen_id = "SP_0001", sample_id = "SA_0001", is_proband = true, affected_status = true, affected_status_code = "affected", family_id = Some("FM00001"), mother_id = Some("PA0003"), father_id = Some("PA0002"), covgene_urls = Some(Set("s3a://1.csv")), exomiser_urls = Some(Set("s3a://1.tsv"))),
      EnrichedClinicalOutput(patient_id = "PA0002", gender = "Male", analysis_service_request_id = "SRA0001", service_request_id = "SRS0002", bioinfo_analysis_code = "GEAN", practitioner_role_id = "PPR00101", batch_id = "BAT1", aliquot_id = "2", specimen_id = "SP_0002", sample_id = "SA_0002", is_proband = false, affected_status = false, affected_status_code = "not_affected", family_id = Some("FM00001"), mother_id = None, father_id = None, covgene_urls = Some(Set("s3a://2.csv")), exomiser_urls = Some(Set("s3a://2.tsv"))),
      EnrichedClinicalOutput(patient_id = "PA0003", gender = "Female", analysis_service_request_id = "SRA0001", service_request_id = "SRS0003", bioinfo_analysis_code = "GEAN", practitioner_role_id = "PPR00101", batch_id = "BAT1", aliquot_id = "3", specimen_id = "SP_0003", sample_id = "SA_0003", is_proband = false, affected_status = true, affected_status_code = "affected", family_id = Some("FM00001"), mother_id = None, father_id = None, covgene_urls = Some(Set("s3a://3.csv")), exomiser_urls = Some(Set("s3a://3.tsv"))),

      // 2. Trio+
      EnrichedClinicalOutput(patient_id = "PA0004", gender = "Male", analysis_service_request_id = "SRA0004", service_request_id = "SRS0004", bioinfo_analysis_code = "TEBA", practitioner_role_id = "PPR00101", batch_id = "BAT1", aliquot_id = "4", specimen_id = "SP_0004", sample_id = "SA_0004", is_proband = true, affected_status = true, affected_status_code = "affected", family_id = Some("FM00004"), mother_id = Some("PA0007"), father_id = Some("PA0006"), exomiser_urls = Some(Set("s3a://4.tsv"))),
      EnrichedClinicalOutput(patient_id = "PA0005", gender = "Male", analysis_service_request_id = "SRA0004", service_request_id = "SRS0005", bioinfo_analysis_code = "TEBA", practitioner_role_id = "PPR00101", batch_id = "BAT1", aliquot_id = "5", specimen_id = "SP_0005", sample_id = "SA_0005", is_proband = false, affected_status = true, affected_status_code = "affected", family_id = Some("FM00004"), mother_id = Some("PA0007"), father_id = Some("PA0006"), exomiser_urls = Some(Set("s3a://5.tsv"))),
      EnrichedClinicalOutput(patient_id = "PA0006", gender = "Male", analysis_service_request_id = "SRA0004", service_request_id = "SRS0006", bioinfo_analysis_code = "TEBA", practitioner_role_id = "PPR00101", batch_id = "BAT1", aliquot_id = "6", specimen_id = "SP_0006", sample_id = "SA_0006", is_proband = false, affected_status = false, affected_status_code = "not_affected", family_id = Some("FM00004"), mother_id = None, father_id = None, exomiser_urls = Some(Set("s3a://6.tsv"))),
      EnrichedClinicalOutput(patient_id = "PA0007", gender = "Female", analysis_service_request_id = "SRA0004", service_request_id = "SRS0007", bioinfo_analysis_code = "TEBA", practitioner_role_id = "PPR00101", batch_id = "BAT1", aliquot_id = "7", specimen_id = "SP_0007", sample_id = "SA_0007", is_proband = false, affected_status = false, affected_status_code = "not_affected", family_id = Some("FM00004"), mother_id = None, father_id = None, exomiser_urls = Some(Set("s3a://7.tsv"))),

      // 3. Incomplete trio
      EnrichedClinicalOutput(patient_id = "PA0011", gender = "Male", analysis_service_request_id = "SRA0011", service_request_id = "SRS0011", bioinfo_analysis_code = "GEAN", practitioner_role_id = "PPR00102", batch_id = "BAT2", aliquot_id = "11", specimen_id = "SP_0011", sample_id = "SA_0011", is_proband = true, affected_status = true, affected_status_code = "affected", family_id = Some("FM00011"), mother_id = Some("PA0022"), father_id = Some("PA0033"), covgene_urls = Some(Set("s3a://11-1.csv", "s3a://11-2.csv", "s3a://11-3.csv"))),
      EnrichedClinicalOutput(patient_id = "PA0022", gender = "Female", analysis_service_request_id = "SRA0011", service_request_id = "SRS0022", bioinfo_analysis_code = "GEAN", practitioner_role_id = "PPR00102", batch_id = "BAT2", aliquot_id = "22", specimen_id = "SP_0022", sample_id = "SA_0022", is_proband = false, affected_status = true, affected_status_code = "affected", family_id = Some("FM00011"), mother_id = None, father_id = None, covgene_urls = Some(Set("s3a://22-1.csv", "s3a://22-2.csv"))),
      EnrichedClinicalOutput(patient_id = "PA0033", gender = "Male", analysis_service_request_id = "SRA0011", service_request_id = "SRS0033", bioinfo_analysis_code = "GEAN", practitioner_role_id = "PPR00102", batch_id = "BAT3", aliquot_id = "33", specimen_id = "SP_0033", sample_id = "SA_0033", is_proband = false, affected_status = true, affected_status_code = "affected", family_id = Some("FM00011"), mother_id = None, father_id = None, covgene_urls = Some(Set("s3a://33.csv"))),

      // 4. Same family, two prescriptions
      // 4.1 First prescription: Duo
      EnrichedClinicalOutput(patient_id = "PA0111", gender = "Female", analysis_service_request_id = "SRA0111", service_request_id = "SRS0111", bioinfo_analysis_code = "GEAN", practitioner_role_id = "PPR00102", batch_id = "BAT2", aliquot_id = "111", specimen_id = "SP_0111", sample_id = "SA_0111", is_proband = true, affected_status = true, affected_status_code = "affected", family_id = Some("FM00111"), mother_id = Some("PA0222"), father_id = None),
      EnrichedClinicalOutput(patient_id = "PA0222", gender = "Female", analysis_service_request_id = "SRA0111", service_request_id = "SRS0222", bioinfo_analysis_code = "GEAN", practitioner_role_id = "PPR00102", batch_id = "BAT2", aliquot_id = "222", specimen_id = "SP_0222", sample_id = "SA_0222", is_proband = false, affected_status = false, affected_status_code = "not_affected", family_id = Some("FM00111"), mother_id = None, father_id = None),
      // 4.2 Second prescription: Trio
      EnrichedClinicalOutput(patient_id = "PA0333", gender = "Female", analysis_service_request_id = "SRA0333", service_request_id = "SRS0333", bioinfo_analysis_code = "GEAN", practitioner_role_id = "PPR00102", batch_id = "BAT3", aliquot_id = "333", specimen_id = "SP_0333", sample_id = "SA_0333", is_proband = true, affected_status = true, affected_status_code = "affected", family_id = Some("FM00222"), mother_id = Some("PA0222"), father_id = None, covgene_urls = Some(Set("s3a://333.csv")), exomiser_urls = Some(Set("s3a://333.tsv"))),
      EnrichedClinicalOutput(patient_id = "PA0111", gender = "Female", analysis_service_request_id = "SRA0333", service_request_id = "SRS0444", bioinfo_analysis_code = "GEAN", practitioner_role_id = "PPR00102", batch_id = "BAT3", aliquot_id = "111", specimen_id = "SP_0111", sample_id = "SA_0111", is_proband = false, affected_status = false, affected_status_code = "not_affected", family_id = Some("FM00222"), mother_id = Some("PA0222"), father_id = None),
      EnrichedClinicalOutput(patient_id = "PA0222", gender = "Female", analysis_service_request_id = "SRA0333", service_request_id = "SRS0555", bioinfo_analysis_code = "GEAN", practitioner_role_id = "PPR00102", batch_id = "BAT3", aliquot_id = "555", specimen_id = "SP_0555", sample_id = "SA_0555", is_proband = false, affected_status = true, affected_status_code = "affected", family_id = Some("FM00222"), mother_id = None, father_id = None, covgene_urls = Some(Set("s3a://555.csv"))),
